...
extension Color {
    ...
    // Semantic colors for dynamic light/dark mode
    static let appText = Color(.label)
    static let appSecondaryText = Color(.secondaryLabel)
    static let appSystemBackground = Color(.systemBackground)
    static let appSystemSecondaryBackground = Color(.secondarySystemBackground)
